...
class DrawMav:
    ...
    def get_points(self):
        ...
        ##### TODO #####
        points = np.array([ # define all points relative to the center frame in terms of the above parameters
        ...
        meshColors[1] = yellow # nose-left
        meshColors[2] = yellow # nose-right
        meshColors[3] = yellow # nose-bottom

        meshColors[4] = blue # fuselage-top
        meshColors[5] = blue # fuselage-left
        meshColors[6] = blue # fuselage-right
        meshColors[7] = blue # fuselage-bottom

        meshColors[8] = red # wing-left
        meshColors[9] = red # wing-right
        meshColors[10] = red # tailwing-left
        meshColors[11] = red # tailwing-right
